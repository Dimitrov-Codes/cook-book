package com.example.cookbook.bootstrap;

import com.example.cookbook.domain.*;
import com.example.cookbook.repositories.CategoryRepository;
import com.example.cookbook.repositories.NotesRepository;
...
public class Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public Bootstrap(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, NotesRepository notesRepository) {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        log.debug("Loading data using Bootstrap");
        UnitOfMeasure ml = new UnitOfMeasure();
        ml.setUom("ml");
        unitOfMeasureRepository.save(ml);
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.addIngredient(new Ingredient("serrano whiles, stems and seeds removed, minced", new BigDecimal(2), eachUom));
